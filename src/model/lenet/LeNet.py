...
class LeNet(Model):
    ...
    def __init__(self, input, label):
        ...
        self.conv1 = nnet.layer.ConvolutionLayer(input = input, filter_shape =  self.conv1_kernel_shape, stride = self.conv1_stride, padding = self.conv1_padding, name = "conv1")
        ...
        self.output_layer = nnet.layer.SoftmaxOutputLayerWithLoss(input = self.conv2_flatten, n_in = self.fc1_input_units, n_out = self.fc1_hidden_units, label = label, name = 'fc1')
